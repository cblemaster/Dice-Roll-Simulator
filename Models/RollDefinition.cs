...
internal sealed class RollDefinition
{
    ...
    private RollDefinition(uint sides, uint count, int modifier)
    {
        Sides = sides;
        Count = count;
        Modifier = modifier;
    ...
    internal static RollDefinition Create(uint sides, uint count, int modifier) =>
